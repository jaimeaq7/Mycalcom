...
export const WEBSITE_URL = process.env.NEXT_PUBLIC_WEBSITE_URL || "https://citas.autoiax.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "citas.autoiax.com.com";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@citas.autoiax.com";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "citas.autoiax.com, Inc.";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "citas.autoiax.com";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "citas.autoiax.com";
...
export const IS_CALCOM =
  WEBAPP_URL &&
  (new URL(WEBAPP_URL).hostname.endsWith("citas.autoiax.com") ||
...
export const CONSOLE_URL =
  ...
  process.env.NODE_ENV !== "production"
    ...
    : `https://console.citas.autoiax.com`;
...
export const POWERED_BY_URL = "https://citas.autoiax.com";
export const DOCS_URL = "https://citas.autoiax.com/docs";
export const DEVELOPER_DOCS = "https://citas.autoiax.com";
...
export const CALCOM_PRIVATE_API_ROUTE = process.env.CALCOM_PRIVATE_API_ROUTE || "https://citas.autoiax.com";
export const WEBSITE_PRIVACY_POLICY_URL =
  process.env.NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL || "https://citas.autoiax.com/privacy";
export const WEBSITE_TERMS_URL = process.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "https://citas.autoiax.com/terms";
